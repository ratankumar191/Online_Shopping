<%-- 
    Document   : buyedit
    Created on : Sep 18, 2016, 2:03:10 AM
    Author     : Ratan
--%>
...
<% 
	 ...
	 {
%>
<!-- <form action="updatemem.jsp" method="post"><table width="473" height="138" border="1"> -->
<form action="orderconf.jsp" method="post"><table width="473" height="138" border="1">
  <tr>
